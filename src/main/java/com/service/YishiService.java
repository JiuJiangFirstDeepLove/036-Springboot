...
public interface YishiService extends IService<YishiEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<YishiEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<YishiEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<YishiEntity> wrapper);
}
